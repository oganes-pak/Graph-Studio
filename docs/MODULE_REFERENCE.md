> ⚠️ **Архивная документация v8.** После добавления десяти типов диаграмм в v9 номера строк и часть структуры изменились. Для актуальной архитектуры используйте `README.md`, `DIAGRAMS_V9.md`, `CHANGELOG_V9.md` и исходный код.
